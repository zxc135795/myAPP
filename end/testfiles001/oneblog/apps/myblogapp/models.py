...
class Article(models.Model):
    ...
    tags = models.ForeignKey(Ads,on_delete=models.CASCADE,verbose_name='配图')
...
class Recommend(models.Model):
    title = models.CharField(max_length=20, verbose_name='友情推荐标题')
    url = models.URLField(default='http://www.baidu.com', verbose_name='友情链接')
